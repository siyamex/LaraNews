...
class UpdatePostRequest extends FormRequest
{
    ...
    {
        return [
            'type'   => 'sometimes|in:article,gallery,video,audio,poll,trivia_quiz,personality_quiz,recipe,event,sorted_list,live_blog',
            ...
            'translations.dv.title' => 'sometimes|required|string|max:255',
