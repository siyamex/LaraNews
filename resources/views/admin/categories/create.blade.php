...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">New Category</h1>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 space-y-4">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="translations[dv][name]" value="{{ old('translations.dv.name') }}"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="translations[en][slug]" value="{{ old('translations.en.slug') }}"
                ...
                <div>
                    ...
                    <input type="text" name="translations[dv][slug]" value="{{ old('translations.dv.slug') }}"
                           class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm font-mono text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="color" name="color" value="{{ old('color', '#DC2626') }}"
            ...
            <div>
                ...
                <textarea name="translations[en][description]" rows="2"
                          class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 shadow-sm">{{ old('translations.en.description') }}</textarea>
            </div>
            ...
            <div class="flex gap-6">
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="show_in_menu" value="1" {{ old('show_in_menu', true) ? 'checked' : '' }}
                           class="rounded border-gray-300 text-red-600">
        ...
        <div class="flex gap-3">
            <button type="submit" class="px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium">Save Category</button>
